...
export default function SettingsPanel({
  ...
  const selectedLangStyle = (target) =>
    lang === target
      ? [
          styles.langChip,
          styles.langChipSelected,
          { borderColor: colors.buttonBg, backgroundColor: colors.buttonBg },
        ]
      : [
          styles.langChip,
          { borderColor: colors.inputBorder, backgroundColor: colors.cardBg },
        ];
  const selectedLangText = (target) =>
    lang === target
      ? [styles.langText, { color: colors.buttonText }]
      : [styles.langText, { color: colors.text }];
